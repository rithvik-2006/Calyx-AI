    ...
    <main className="w-full max-w-[430px] px-lg py-xl flex flex-col justify-center min-h-[1024px]">
      <div className="flex flex-col items-center mb-xl w-full text-center">
        ...
        <p className="font-body-lg text-on-surface-variant">
          Join Calyx AI to start your journey.
        </p>
      </div>
      ...
      <form onSubmit={handleRegister} className="w-full flex flex-col gap-md">
        ...
        <button 
          type="submit" 
          disabled={loading}
          className="group w-full bg-[#FFFFFF] text-[#000000] font-headline-md py-[18px] rounded-[24px] hover:bg-opacity-90 transition-all duration-300 transform active:scale-[0.98] mt-lg flex items-center justify-center gap-sm disabled:opacity-50"
        >
      ...
      <div className="mt-xl text-center w-full">
        <p className="font-body-sm text-on-surface-variant">
          ...
          <Link href="/login" className="text-on-surface font-medium hover:underline underline-offset-4 ml-sm">
            Sign in
          </Link>
        </p>
      </div>
